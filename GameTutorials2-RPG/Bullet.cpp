...
{
	GAME_PHYSICS physics(GAME_BODY_TYPE::GAME_DYNAMIC, GAME_OBJECT_SHAPE::GAME_CIRCLE, 12, 12, 8.f, 1.0f, 0.f, .1f, 1.f, 4.f, 0.f, 10.f, CATEGORY_BULLET, MASK_BULLET, true);
	physics.offSetX = 8;
	physics.offSetY = 48;
	...
	//Movement
	std::shared_ptr<Movement> movement = std::make_shared<Movement>(sprite, sf::Vector2f(30.f, 30.f), sf::Vector2f(5.f, 5.f), sf::Vector2f(1.f, 1.f), *this); //speed for bullet set here
