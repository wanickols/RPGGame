...
(
	...
	float exp_mult, float vitality_multiplier, 
	float strength_multiplier, float dexterity_multiplier, 
	float agility_multiplier, float intelligence_multiplier, 
	Item* dropItem, std::shared_ptr<EnemySpawner> origin, 
	Entity& owner
)
