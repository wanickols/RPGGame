...
private:
	...
	public:
		...
		TextTag(std::shared_ptr<TextTag> tag, float pos_x, float pos_y, std::string str)
		{
			this->text = tag->text;
			this->text.setFont(*tag->text.getFont());
			this->text.setString(str);
			this->text.setFillColor(tag->text.getFillColor());
			this->text.setCharacterSize(tag->text.getCharacterSize());
			this->text.setPosition(pos_x, pos_y);
	...
	sf::Font font;
	std::map<unsigned, std::shared_ptr<TextTag>> tagTemplates;
